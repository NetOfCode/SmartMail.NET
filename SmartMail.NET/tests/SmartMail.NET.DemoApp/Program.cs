...
app.MapPost("/send-email", async (ISmartMailService emailService) =>
{
...
app.MapPost("/send-email-ses", async (ISmartMailService emailService) =>
{
    var message = new EmailMessage
    {
        To = "recipient@example.com",
...
app.MapPost("/send-bulk-emails", async (ISmartMailService emailService, ILogger<Program> logger) =>
{

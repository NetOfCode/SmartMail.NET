...
namespace SmartMail.NET.Tests
{
    public class SmartMailServiceTests
    {
        ...
        private readonly SmartMailService _SmartMailService;

        public SmartMailServiceTests()
        {
            _mockProvider = new Mock<IEmailProvider>();
            _mockProviderManager = new Mock<IEmailProviderManager>();
            _mockLogger = new Mock<ILogger<SmartMailService>>();
            ...
            _SmartMailService = new SmartMailService(pipeline, _mockProviderManager.Object, _mockLogger.Object);
        }
        ...
        public async Task SendAsync_ValidEmail_ShouldSucceed()
        {
            ...
            // Act
            var result = await _SmartMailService.SendAsync(message);
        ...
        public async Task SendAsync_InvalidEmail_ShouldFail()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<System.Exception>(() => _SmartMailService.SendAsync(message));
